  ...
  if (login) {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-top  bg-gray-100">
        ...
        <div className='mt-5 '>
        <button  type ="submit" className="flex mt-2 items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-500 hover:bg-blue-600 rounded-2xl py-2 w-full transition duration-150 ease-in" onClick={() => setLogin(true)}>
          Войти
        </button>
        </div>
      </div>
